...
kubectl get svc
Observation: Review the EXTERNAL-IP field and you will see it as localhost. Access the nginx page at localhost
...
# if above solution not works 
kubectl port-forward service/webapp-nginx 8080:80
